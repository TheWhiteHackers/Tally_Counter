...
containdiv.innerHTML+="<div class='card'><input type='text' id='text"+cardcount+"'><center><div class='num' id='card"+cardcount+"'>0</div></center><button class='minus' onclick='tallyupdate("+cardcount+", -1)'>-</button><button class='plus' onclick='tallyupdate("+cardcount+", 1)'>+</button></div>";
cardcount++;
